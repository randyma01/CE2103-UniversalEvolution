...
public class XMLgenerations extends XML {
    ...
    public void añadirGen(doubleList enemigo) throws TransformerException{
    	
    	if(enemigo.obtener(0)=="O"){
    		...
    		Text cont=documento.createTextNode(enemigo.obtener(1));
    		Text cont1=documento.createTextNode(enemigo.obtener(2));
    		Text cont2=documento.createTextNode(enemigo.obtener(3));
    		Text cont3=documento.createTextNode(enemigo.obtener(4));
    		Text cont4=documento.createTextNode(enemigo.obtener(5));
